...
export function calculateNextRun(
  ...
  console.log('🕐 Calculating next run:', {
    ...
    fromDateKST: new Date(fromDate.getTime() + 0.5 * 60 * 60 * 1000).toISOString() // +0.5 hours offset
  })
  ...
  // 한국 시간대로 변환해서 계산 (+30분 보정)
  const koreaOffsetMs = 0.5 * 60 * 60 * 1000 // +0.5 hours offset
